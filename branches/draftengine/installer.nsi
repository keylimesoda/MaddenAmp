...
!define PRODUCT_NAME "Gommo's Madden Editor - Draft Beta 6"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Gommo's Madden Editor - Draft Beta 6"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 6 (${PRODUCT_VERSION}).lnk" "$INSTDIR\MaddenEditor-Draft.exe"

  CreateShortCut "$DESKTOP\Gommo's Madden Editor - Draft Beta 6.lnk" "$INSTDIR\MaddenEditor-Draft.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Gommo's Madden Editor - Draft Beta 6.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 6 (${PRODUCT_VERSION}).lnk"
