...
!define PRODUCT_NAME "Gommo's Madden Editor - Draft Alpha 4"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Gommo's Madden Editor - Draft Alpha 4"
...
InstallDir "$PROGRAMFILES\Gommo's Madden Editor - Draft Alpha 4"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Alpha 4 (${PRODUCT_VERSION}).lnk" "$INSTDIR\MaddenEditor-Draft.exe"

  CreateShortCut "$DESKTOP\Gommo's Madden Editor - Draft Alpha 4.lnk" "$INSTDIR\MaddenEditor-Draft.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Gommo's Madden Editor - Draft Alpha 4.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Alpha 4 (${PRODUCT_VERSION}).lnk"
