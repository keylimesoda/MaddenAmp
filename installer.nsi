...
!define PRODUCT_NAME "Gommo's Madden Editor - Draft Beta 3"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Gommo's Madden Editor - Draft Beta 3"
...
InstallDir "$PROGRAMFILES\Gommo's Madden Editor - Draft Beta 3"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 3 (${PRODUCT_VERSION}).lnk" "$INSTDIR\MaddenEditor-Draft.exe"

  CreateShortCut "$DESKTOP\Gommo's Madden Editor - Draft Beta 3.lnk" "$INSTDIR\MaddenEditor-Draft.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Gommo's Madden Editor - Draft Beta 3.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 3 (${PRODUCT_VERSION}).lnk"
