...
!define PRODUCT_NAME "Gommo's Madden Editor - Draft Beta 5"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Gommo's Madden Editor - Draft Beta 5"
...
InstallDir "$PROGRAMFILES\Gommo's Madden Editor - Draft Beta 5"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 5 (${PRODUCT_VERSION}).lnk" "$INSTDIR\MaddenEditor-Draft.exe"

  CreateShortCut "$DESKTOP\Gommo's Madden Editor - Draft Beta 5.lnk" "$INSTDIR\MaddenEditor-Draft.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Gommo's Madden Editor - Draft Beta 5.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\Gommo's Madden Editor - Draft Beta 5 (${PRODUCT_VERSION}).lnk"
